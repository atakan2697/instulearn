...
Feature: US023 - Kurs paketi olusturulabilmesi ve yonetilebilmesi
  ...
  Scenario: New linki görünür ve aktif olmalı
  ...
  Scenario: Basic Info icin Gerekli Form bilgileri doldurulması ve alt butonların gorunurluk ve aktiflik dogrulanmasi
  ...
  Scenario: Extra Information icin form bilgileri doldurulması
